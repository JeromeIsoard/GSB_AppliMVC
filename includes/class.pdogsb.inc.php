...
class PdoGsb
{
	...
	// accès serveur distant
	// private static $serveur = 'mysql:host=jeromeispn78.mysql.db';
    // private static $bdd = 'dbname=jeromeispn78';
    // private static $user = 'jeromeispn78';
    // private static $mdp = 'zhX7KYGn89j7';
    // private static $monPdo;
    // private static $monPdoGsb = null;
...
//        $requetePrepare->bindParam(':unPrenomVisiteur', $prenom, PDO::PARAM_STR);
     ...
     * @param type $mdp   Mot de passe du comptable
     * 
     * @return l'id, le nom et le prénom sous la forme d'un tableau associatif
     */
...
//        die();
     ...
     */
    public function getLesFichesVAetMP()
    {
        $requetePrepare = PdoGSB::$monPdo->prepare(
            'SELECT fichefrais.idetat as idEtat, '
            . 'fichefrais.datemodif as dateModif,'
    ...
    /**
     * Retourne le montant du frais forfait dont l'id est passé en parametre.
     * 
    ...
    /**
     * Met à jour le montant validé de la fiche correspondante au visiteur et au
     * mois passé en parametre
     * 
     ...
     * @return null
     */
    public function majMontantValide($idVisiteur, $mois, $unMontant)
    {
        $requetePrepare = PdoGsb::$monPdo->prepare(
            'UPDATE fichefrais '
